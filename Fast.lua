...
LuaTele = luatele.set_config{api_id=17784375,api_hash='f4979d23cf6e9c58fcf7886f123cdee6',session_name=Fast,token=Token}
function var(value)
...
photo = "https://t.me/Kimmetb0t"
local list = Redis:smembers(Fast.."total")
local JABWA = "*❂ عدد مشتركين بوتك『 "..#list.." 』مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ᴋɪᴍᴍᴇᴛ ѕσᴜꝛᴄᴇ 𓃠', url = 't.me/Kimmetb0t '},
},
{
{text = 'مطور الصانع', url = 't.me/si_i_i '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("si_i_i")
...
local TestText = "*⦿ مطور سورس كيمت\n╭⦿ᚐɴᴀᴍᴇ › * ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*╰⦿ᚐʙɪᴏ › "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/si_i_i"}
},
}
...
keyboard.inline_keyboard = {
{
{text = 'مطور السورس', url = 't.me/si_i_i '},{text = 'تنصيب بوت مدفوع', url = 't.me/si_i_i'},
},
{
{text = 'قناة التحديثات', url = 't.me/Kimmetb0t '},{text = 'ᴋɪᴍᴍᴇᴛ ѕσᴜꝛᴄᴇ 𓃠', url = 't.me/Kimmetb0t '},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
