...
data = {
{
{text = '１', data = IdUser..'/help1'}, {text = '２', data = IdUser..'/help2'}, {text = '３', data = IdUser..'/help3'}
},
{
{text = '４', data = IdUser..'/help4'}, {text = '５', data = IdUser..'/help5'}, {text = '６', data = IdUser..'/helpp6'}, 
},
{
...
{
{text = '𓃠 ᴀᴅᴅ.ᴍᴇ 𓃠', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
}
local TextHelp = [[*
...
return send(msg_chat_id,msg_id,'❂ اهلا بك عزيزي العضو ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *المطور الاساسي* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *البوت* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *الرتب وحذفها* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *الاذاعه للبوت* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *التفعيل والتعطيل* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *المحظورين والمكتومين* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( *الخاص بالسورس* ) ', 'md', false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'╮⦿ › هلا حبيبي المطور\n╯⦿ › إليك قسم ( * المحظورين و المكتومين* ) ', 'md', false, false, false, false, reply_markup)
elseif text == 'قسم المطور الاساسي' then
local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
