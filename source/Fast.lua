...
bot = Fx.Fastbots.set_config{api_id=17784375,api_hash='f4979d23cf6e9c58fcf7886f123cdee6',session_name=Fast,token=Token}
chsource = Redis:get(Fast..'chsource') or "Kimmetb0t"
devsource = Redis:get(Fast..'devsource') or "si_i_i"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,7158456464,627658332,62768387658332,5986905976848034,643089774417482,55555555555,5555555555}
...
if UserId == 7158456464 then
Status = true
elseif UserId == 664546631745 then
Status = true
elseif UserId == 55555555555 then
Status = true
elseif UserId == 5969871799722 then
Status = true
...
if UserId == 7158456464 then
Status = 'المبرمج شيكو 🤍'
elseif UserId == 664698631745 then
Status = 'مطوره السـورس 🤍'
elseif UserId == 55555555555 then
Status = 'مطـور السـورس '
elseif UserId == 6439988177482 then
Status = 'مطـور السـورس '
elseif UserId == 598699988905034 then
...
elseif tonumber(Message) < 284737738383831 then 
...
elseif UserId == 5555555555 then
Status = true
elseif UserId == 28473773838383 then
Status = true
elseif UserId == 28473773838383 then
Status = true
...
if tonumber(senderr) == 7158456464 then
msg.Name_Controller = 'المبرمج شيكو 🤍🔥.'
msg.The_Controller = 1
elseif tonumber(senderr) == 28473773838383 then
...
if msg.sender_id.user_id == tonumber(7158456464) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج شيكو نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(28473773838383) then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[كيمت]")
...
local name_parlo = bot.getUser(7158456464).first_name.." "..bot.getUser(7158456464).last_name
local caption = "اليك قائمه مطورين سورس توم :"
if tonumber(UserId_Info.id) ~= 7158456464 then
...
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@7158456464'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/Kimmetb0t ", 'md', true)
end
...
if text == "حذف قسم" then
  ...
  if ChannelJoin(msg) == false then
  local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Kimmetb0t'}, },}}
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(7158456464) then
...
local T =[[
[نعم تفضل وياك اسراء مطوره بوت كيمت ♡](t.me/YQYQY6 )
]]
keyboard = {} 
...
{
{text = '𓃠 ѕσᴜꝛᴄᴇ 𓃠', url = 'http://t.me/'..chsource..''}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'شيكو' or text == 'شيكوو' then
photo = "https://t.me/si_i_i"
local T =[[
[نعم عزيزي تفضل وياك توم](t.me/si_i_i)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'sʜɪᴋσσ', url = "https://t.me/si_i_i"}
},
{
{text = '𓃠 ѕσᴜꝛᴄᴇ 𓃠', url = 'http://t.me/'..chsource..''}
},
...
❂ توب المتزوجين ↢ يطلع لك اغنى 10 ازواج بالجروب
اذا لاحظت اي اخطاء باللعبه راسل المطورين هنا👇.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓃠 ᴅᴇᴠ 𓃠 .', url = "https://t.me/si_i_i"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'المبرمج' or text == 'توم' or text  == 'المبرمج شيكو' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(7158456464,0,'*\n❂ مرحباً عزيزي المبرمج شيكو \nشخص ما يحتاج الي مساعده\nٴ𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳\n❂ اسمه :- '..klajq..' \n❂ ايديه :-  : '..msg.sender_id.user_id..'\n❂ - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
...
if msg.sender_id.user_id == tonumber(7158456464) then
send(msg_chat_id,msg_id,"❂ انت شيكو مطور السورس 🤍. ","md",true)
elseif msg.sender_id.user_id == tonumber(6646628131745) then
...
elseif msg.sender_id.user_id == tonumber(59869435805034) then
...
send(msg_chat_id,msg_id,"❂ انت مالك الجروب","md",true)
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(7158456464) then
local txx = "\n"
...
return send(msg_chat_id,msg_id,'\n❂ مرحبا بك في السجل المدني الخاص بسورس كيمت\nاكتب اسمك الان :',"md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/Kimmetb0t"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@Kimmetb0t")
sleep(1)
...
data = {
{
{text = '𓃠 ѕσᴜꝛᴄᴇ 𓃠', url = 'http://t.me/'..chsource..''}, {text = '𓃠 ᴅᴇᴠ 𓃠', url = 't.me/'..devsource}, 
},
{
{text = 'ᴀᴅᴅ ᴍᴇ 𓃠', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
𓃠 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴋɪᴍᴍᴇᴛ ѕᴏᴜꝛᴄᴇ
...
if text == (Redis:get(Fast.."Name:Bot") or "كيمت") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "كيمت")
local Mostafa = {
'نعم حبيبي تفضل',
'لا تصيحلي',
'شتريد',
...
if text == 'شيكوو' or text == 'مبرمج السورس' or text == 'bdhdjidi' then  
local UserId_Info = bot.searchPublicChat("si_i_i")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "𓃠 ᴅᴇᴠ sʜɪᴋσσ\n⊰•━━━━━━━━━━━━━•⊱\n𓃠  ᴅᴇᴠ › ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n𓃠 ʙɪᴏ › [ "..Bio.." ]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '˹sʜɪᴋσσ ✗ شـيـڪـوو˼ › 𓃠 ⤶', url = "https://t.me/si_i_i"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '˹sʜɪᴋσσ ✗ شـيـڪـوو˼ › 𓃠 ⤶' , url = 't.me/'..devsource}
},
{
{text = '𓃠 ѕσᴜꝛᴄᴇ 𓃠', url = 'http://t.me/'..chsource..''},
},
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'كيمت سورس' or text == 'سورس كيمت'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '𓃠 ѕσᴜꝛᴄᴇ 𓃠', url = 'http://t.me/'..chsource..''}, {text = '𓃠 ᴄʜᴀᴛ 𓃠', url = "http://t.me/kimmetchat"}
}, 
{
{text = '𓃠 ᴅᴇᴠ 𓃠', url = 't.me/'..devsource}, 
},
{
{text = 'ᴀᴅᴅ ᴍᴇ 𓃠', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[𓃠 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴋɪᴍᴍᴇᴛ ѕᴏᴜꝛᴄᴇ](t.me/Kimmetb0t)
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
